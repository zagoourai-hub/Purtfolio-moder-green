  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-zinc-100">Add New Project</h1>
          <p className="text-sm text-zinc-400">Add a new project case study to your portfolio.</p>
        </div>
        <Button
          variant="outline"
          size="sm"
      ...
      <Card className="border-zinc-800 bg-zinc-900/20 backdrop-blur-md">
        <CardHeader>
          ...
          <CardDescription className="text-zinc-400">
            Define your project settings, cover image, and markdown description.
          </CardDescription>
        </CardHeader>
        <CardContent>
