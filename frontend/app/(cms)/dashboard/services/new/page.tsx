  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-zinc-100">Add New Service</h1>
          <p className="text-sm text-zinc-400">Offer a new service on your website.</p>
        </div>
        <Button
          variant="outline"
          size="sm"
      ...
      <Card className="border-zinc-800 bg-zinc-900/20 backdrop-blur-md">
        <CardHeader>
          ...
          <CardDescription className="text-zinc-400">
            Define your service title, pricing model, and descriptions.
          </CardDescription>
        </CardHeader>
        <CardContent>
