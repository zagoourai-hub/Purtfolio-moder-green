...
export default function NewTestimonialPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    createTestimonialMutation.mutate(submitData, {
      onSuccess: () => {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-zinc-100">Add Testimonial</h1>
          <p className="text-sm text-zinc-400">Save a new client recommendation.</p>
        </div>
        <Button
          variant="outline"
          size="sm"
      ...
      <Card className="border-zinc-800 bg-zinc-900/20 backdrop-blur-md">
        <CardHeader>
          ...
          <CardDescription className="text-zinc-400">
            Enter client information, rating, and feedback content.
          </CardDescription>
        </CardHeader>
        <CardContent>
