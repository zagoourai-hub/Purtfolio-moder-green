...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[400px] flex-col items-center justify-center overflow-hidden bg-zinc-950 w-full z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(var(--conic-position), rgba(208, 240, 0, 0.25), transparent, transparent)`,
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(var(--conic-position), transparent, transparent, rgba(208, 240, 0, 0.25))`,
          }}
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-yellow-300/15 blur-3xl"></div>
        
        {/* Yellow light source (dimmed to 15% opacity, isolated positioning container) */}
        <div 
          style={{
            left: "50%",
            transform: "translateX(-50%) translateY(-96px)",
          }}
          className="absolute z-30 h-36"
        >
          <motion.div
            initial={{ width: "8rem" }}
            ...
            className="h-full rounded-full bg-yellow-400/15 blur-2xl mx-auto"
          ></motion.div>
        </div>
        
        {/* Horizontal neon line divider (isolated positioning container, 60% opacity) */}
        <div 
          style={{
            left: "50%",
            transform: "translateX(-50%) translateY(-152px)",
          }}
          className="absolute z-50 h-0.5"
        >
          <motion.div
            initial={{ width: "15rem" }}
            ...
            className="h-full bg-yellow-300/60 mx-auto"
          ></motion.div>
        </div>
